...
import org.pentaho.ui.xul.test.models.TestModel;
import org.pentaho.ui.xul.test.models.TestModel.TestDocumentField;

/**
 * This harness demonstrates binding an AbstractModelList to a XUL table. 
 * Refer to the init() method for proper binding of the model to the UI. 
 * 
 * This harness also demonstrates enabling the context menu (insert, delete and keep only 
 * menus available in Swing impl). Refer to the createNewRow() method for details.
 * 
 * @author gmoran
 *
 */
public class SwingModelHarness extends AbstractXulEventHandler{
  ...
  public SwingModelHarness() {
    ...
    try{
      ...
      XulDomContainer container = new SwingXulLoader().loadXul("resource/documents/treecontextmenu.xul");
   ...
   * 
   * This will be invoked by the "insert row" UI interaction (currently a 
   * right-click context menu enabled by the presence of the "newitembinding" 
   * attribute.
   * 
   */
