...
public interface XulOverlay {
  ...
  /**
   * Default priority value assigned to an overlay when
   * the priority attribute is not present in the overlay XML.
   * Priority value is used to determine the order in which
   * to apply overlays in order to guarantee the order of
  ...
  /**
   * Returns the int indicating the priority order in which the overlay
   * should be applied
