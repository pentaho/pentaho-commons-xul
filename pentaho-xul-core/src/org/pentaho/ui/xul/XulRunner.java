 ...
 * a completely XUL based user interface. 
 * 
 * @author nbaker
 *
 */
public interface XulRunner {
  ...
  /**
   * Initialize any internal params, perform any 
   * pre-application tasks for the runner. 
   * 
   * @throws XulException Exception thrown if the 
   ...
   * 
   * @throws XulException Exception thrown if the 
   * shutdown fails for any reason. 
   *
   */
  public void stop() throws XulException;
  
  /**
   * Add a new container to this runner. Each container represents 
   * a series of DOM models and their event handlers.  
   *
   * @param xulDomContainer The container to add to the runner.
   *  
   */
