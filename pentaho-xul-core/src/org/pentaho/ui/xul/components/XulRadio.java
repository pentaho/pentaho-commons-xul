...
public interface XulRadio extends XulComponent {
   ...
   * 
   * @param label the radio label that should display. 
   */
  ...
  /**
   * According to XUL spec, this is the appropriate 
   * event to listen to for radio state changes from 
   * a user interface. Note that to remain pure to the spec, 
   * this will not report a state change set via code or script. 
   * 
   * @see radioStateChange at http://www.xulplanet.com/references/elemref/ref_EventHandlers.html
   * 
   * @param method The method to execute when the radio is checked or unchecked. 
   */
