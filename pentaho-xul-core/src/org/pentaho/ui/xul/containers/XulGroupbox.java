...
/**
 * An interface for the XUL container groupbox. A groupbox behaves much like the XulBox, except that a groupbox has a
 * border drawn around its edge, and optionally can display a title at the top, using a XulCaption widget.
 * 
