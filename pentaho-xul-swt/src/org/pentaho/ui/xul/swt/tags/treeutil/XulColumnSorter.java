...
/**
 * Its unfortunate due to the lack of a base class or common interface between a tree and a table in SWT that we must resort
 * to this random separation of code in an abstract class. The pieces that have been abstracted are those that
