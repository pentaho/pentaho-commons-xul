...
public class SwtTree extends SwtElement implements XulTree {
  ...
  protected XulComponent parent = null;
  ...
  public SwtTree(XulComponent parent, XulDomContainer container, String tagName) {
    ...
    widget = isHierarchical ? new TreeWrapper(selType, (Composite)parent.getManagedObject()) 
                            : new TableWrapper(selType, (Composite)parent.getManagedObject());
  ...
  public void setDisabled(boolean disabled) {
    ...
    if (!tree.isDisposed()) tree.setEnabled( !disabled );
  }
