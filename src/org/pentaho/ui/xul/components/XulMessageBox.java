 ...
 * 
 * Rather than try to build message boxes from standard XUL XML definitions, it seemed 
 * much more efficient at this time to use the rich messagebox utilities already
 * build into each UI technology. 
 *  
 * @author gmoran
 *
 */
public interface XulMessageBox {
  ...
  /**
   * Sets the buttons to show on the messagebox dialog.
   * Values for this array will be implementation specific. 
   * If buttons is set to null, the default (OK) will be shown.
   *   
   * @param buttons An array of objects representing buttons - 
  ...
  /**
   * Sets a custom icon on the messagebox dialog. 
   * Values for this parameter are implementation specific. 
   * If icon is set to null, no icon is displayed. 
   * If this value is not set at all, the underlying 
   * implementation's version of an information icon is displayed 
   * by default. 
   * 
   * @param icon The icon to display on the messagebox. 
   */
  ...
  /**
   * Creates and opens the messagebox for viewing. Return values
