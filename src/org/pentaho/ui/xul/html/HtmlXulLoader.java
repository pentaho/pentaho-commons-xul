...
public class HtmlXulLoader extends AbstractXulLoader {
	 ...
	 public HtmlXulLoader() throws XulException{
		    ...
		    //attach Renderers
		    parser.registerHandler("WINDOW", "org.pentaho.ui.xul.html.tags.HtmlWindow");
		    /* TODO these are all 
		    ...
		    */
		    parser.registerHandler("MENU", "org.pentaho.ui.xul.html.tags.transmenu.HtmlMenu");
		    parser.registerHandler("MENUPOPUP", "org.pentaho.ui.xul.html.tags.transmenu.HtmlMenupopup");
		    parser.registerHandler("MENUITEM", "org.pentaho.ui.xul.html.tags.transmenu.HtmlMenuitem");
		    parser.registerHandler("MENUBAR", "org.pentaho.ui.xul.html.tags.transmenu.HtmlMenubar");
