...
public class ImageUtil {
  ...
  public static final String ATTRIBUTE_IMAGE_ALT_TEXT = "imagealttext";

  public static final String ATTRIBUTE_PEN_IMAGE_ALT_TEXT = "pen:" + ATTRIBUTE_IMAGE_ALT_TEXT;
   ...
   * <ol>
   *   <li>attribute {@link #ATTRIBUTE_PEN_IMAGE_ALT_TEXT}'s name processed in
   *   {@link AbstractGwtXulComponent#init(com.google.gwt.xml.client.Element, org.pentaho.ui.xul.XulDomContainer)}</li>
   *  <li>attribute {@link #ATTRIBUTE_IMAGE_ALT_TEXT}'s name processed in
   ...
   *   <li>argument: {@code srcEle}'s attribute {@link #ATTRIBUTE_IMAGE_ALT_TEXT}</li>
   ...
   */
  public String getAltText( AbstractGwtXulComponent agxc, Element srcEle ) {
    return getAltText( agxc, srcEle, DEFAULT_IMAGE_ALT_WCAG_TEXT );
  }
   ...
   */
  public String getAltText( AbstractGwtXulComponent agxc, Element srcEle, String defaultAltText ) {
    List<String> texts = new ArrayList<>(); // TODO refactor see GWtToolbarButton.java
    if( agxc != null ) {
      // assuming AbstractGwtXulComponent#init will have processed either "pen:imagealttext" or "imagealttext"
      texts.add( agxc.getAttributeValue( ATTRIBUTE_PEN_IMAGE_ALT_TEXT ) );
      texts.add( agxc.getAttributeValue( ATTRIBUTE_IMAGE_ALT_TEXT ) );
    }

    if ( srcEle != null ) {
      // access from xul tag directly either "pen:imagealttext" or "imagealttext"
      texts.add( srcEle.getAttribute( ATTRIBUTE_PEN_IMAGE_ALT_TEXT ) );
      texts.add( srcEle.getAttribute( ATTRIBUTE_IMAGE_ALT_TEXT ) );
